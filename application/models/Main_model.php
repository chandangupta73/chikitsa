...
class Main_model extends CI_Model {
	...
	public function post_blog_action($cat, $name, $title,$des, $key, $file_name, $msg)
	{
		$data = array(
	...
	public function seo_login($uid)
  {
    return $this->db->get_where('tbl_seo_login',['login_id'=>$uid])->result_array();
  }
}
