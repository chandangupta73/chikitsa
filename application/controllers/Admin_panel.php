...
class Admin_panel extends CI_Controller {
	...
	public function post_blog_action()
	{
		...
		if($this->form_validation->run()== FALSE)
		{
			...
			$des = $this->security->xss_clean($this->input->post('description'));
			$key = $this->security->xss_clean($this->input->post('keywords'));
			...
			else
			{
            	...
            	if($this->Main_model->post_blog_action($cat, $name, $title, $des, $key, $file_name, $msg))
				{
