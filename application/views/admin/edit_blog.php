          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="slug" name="slug" placeholder="Enter slug" required value="<?= !empty($u)?$get[0]['slug']:'';?>">
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="keywords" id="keywords" value="<?= !empty($u)?$get[0]['keywords']: '';?>" placeholder="Enter keywords">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Description</label>
                  <textarea class="form-control" id="description" name="description" rows="5" cols="80"><?= !empty($u)?$get[0]['description']: '';?></textarea>
                </div>
