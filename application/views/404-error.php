                                        ...
                                        <ul class="menu">
                                            ...
                                            <li class="menu-item-has-children current-menu-item current-menu-ancestor">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="current-menu-item"><a href="404-error.html">404 Error</a>
                                                    </li>
                            ...
                            <ul id="menu-main-menu" class="mobile_mainmenu">
                                ...
                                <li class="menu-item-has-children current-menu-item current-menu-ancestor"><a
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="elements.html">Elements</a></li>
                                        <li><a href="faq.html">FAQS</a></li>
                                        <li class="current-menu-item"><a href="404-error.html">404 Error</a></li>
                                        <li><a href="cooming-soon.html">Coming Soon</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children"><a href="#">Services</a>
                                ...
                                <li class="menu-item-has-children"><a href="#">Projects</a>
                                    <ul class="sub-menu">
                                        <li><a href="portfolio-masonry.html">Portfolio Masonry</a></li>
                                        <li><a href="portfolio-carousel.html">Portfolio Carousel</a></li>
                                        <li class="menu-item-has-children"><a href="portfolio-grid.html">Portfolio
                                                Grid</a>
                                            <ul class="sub-menu">
                                        ...
                                        <li class="menu-item-has-children"><a href="portfolio-details-1.html">Portfolio
                                                Details</a>
                                            <ul class="sub-menu">
            ...
            <div class="container">
                <div class="error-404 not-found text-center">
                    ...
                    <div class="content-404">
                        ...
                        <a class="octf-btn" href="index.html">Take Me Home</a>
                    </div>
                </div>
            </div>
